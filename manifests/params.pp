...
class fractalis::params(
    ...
    String[1] $version                          = lookup('fractalis::version', String, first, '1.2.2'),
    String[1] $source_version                   = lookup('fractalis::source_version', String, first, 'master'),
    ...
    if $source_url == undef {
        ...
        $source = "https://github.com/thehyve/Fractalis/archive/${source_version}.zip"
    } else {
        $source_tag = $version
